...
public class AktuelleBedingungenAnzeige implements PropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent e) {
		if (e.getPropertyName().equals("Temperatur")) {
			...
			System.out.println("Aktuelle Bedingungen: " + w.getTemperatur() + " Grad C und " + w.getFeuchtigkeit()
					+ "% Luftfeuchtigkeit.");
		}
		if (e.getPropertyName().equals("Feuchtigkeit")) {
			...
			System.out
					.println("Die Luftfeuchtigkeit hat sich von " + feuchtAlt + "% auf " + feuchtNeu + "% verändert.");
		}
	}
}